...
module.exports = {
  compile() {
    ...
    return BbPromise
      .fromCallback(cb => new webpackDevServer(compiler, options, cb))
      .then(stats => {
        this.serverless.cli.consoleLog('Compiling done, Spinning up static server on port...'.toString({ color: true }));
